    ...
    def SVG(self, trans=None):
        ...
        for datum in self.d:
            ...
            ######################
                ...
                X1, Y1 = X + RX * math.cos(angle * math.pi / 180.0), Y + RX * math.sin(
                    angle * math.pi / 180.0
                )
                X2, Y2 = X + RY * math.sin(angle * math.pi / 180.0), Y - RY * math.cos(
                    angle * math.pi / 180.0
                )
                X3, Y3 = X - RX * math.cos(angle * math.pi / 180.0), Y - RX * math.sin(
                    angle * math.pi / 180.0
                )
                X4, Y4 = X - RY * math.sin(angle * math.pi / 180.0), Y + RY * math.cos(
                    angle * math.pi / 180.0
                )
